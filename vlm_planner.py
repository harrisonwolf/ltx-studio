...
SYSTEM = (
    ...
    "- mode 'single' = one short clip (a few seconds, no evolution). mode 'director' = a longer piece where "
    "a vision model rewrites the prompt each shot toward your DIRECTIVE (the arc). Use 'director' for "
    "anything that should change, progress, or run more than a few seconds.\n"
