...
DIALS = {
    ...
    "steadiness": "[b]STEADINESS[/b]  (director mode)\nHow far the director may stray each shot:\n[b]Hold[/b] — re-assert the exact same scene (faithful; default).\n[b]Balanced[/b] — same subject + setting, gentle variation.\n[b]Evolve[/b] — let it journey / transform toward the DIRECTIVE.\nEvolve for a story; Hold to just make one scene longer.",
